...
# From https://www.datacamp.com/tutorial/building-a-transformer-with-py-torch
import torch
...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_model, num_heads):
        ...
        self.W_q = nn.Linear(d_model, d_model) # define simple linear layer, input d_model, output d_model
        self.W_k = nn.Linear(d_model, d_model)
        self.W_v = nn.Linear(d_model, d_model)
        self.W_o = nn.Linear(d_model, d_model)
        
    def scaled_dot_product_attention(self, Q, K, V, mask=None):
        # torch.matmul means matric multiplication
    ...
    def split_heads(self, x):
        ...
        # return new shape of tensor
        # https://pytorch.org/docs/stable/generated/torch.transpose.html
        # return new order of tensor's dimension
...
## FineTune model 
```python
# From https://www.datacamp.com/tutorial/fine-tuning-llama-2
import os
import torch
